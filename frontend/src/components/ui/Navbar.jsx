...
import logo from "@/assets/images/logoubharajaya.png";
...
export default function Navbar() {
  return (
    <nav className="bg-white brutal-border border-l-0 border-r-0 border-t-0 flex items-center justify-between px-5 md:px-10 h-[70px] sticky top-0 z-[99]">
      ...
      <img
        src={logo.src}
        alt="Universitas Bhayangkara Jakarta Raya"
      ...
      />
        ...
        <span className="font-archivo text-2xl tracking-tight uppercase">Booth Ubhara</span>
      </Link>
